...
def affine_batchnorm_relu_forward(x, w, b, gamma, beta, bn_param):
    ...
    a BatchNorm operation, followed by a ReLU.

    Inputs:
    - x: Input to the affine layer
    - w, b: Weights to the affine layer
    - gamma: BatchNorm gamma variable
    - beta: BatchNorm beta variable
    - bn_param: BatchNorm config parameters:
    ...
    Returns:
    - out: The outputs of the ReLU layer
    - cache: A tuple containing the caches for each step -
